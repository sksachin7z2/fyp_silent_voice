...
def load_process_predict(landmarks,id):
    ...
    for result in landmarks:
        ...
        if 'faceLandmarks' not in result:
            for i in range(468): #
                data.append({
                    'type' : 'face',
                    'landmark_index' : i,
            ...
            # assert(len(result.faceLandmarks.landmark)==468)
            for i in range(468): #
                xyz = result["faceLandmarks"][i]
                data.append({
                    'type' : 'face',
                    'landmark_index' : i,
                    'x' : xyz['x'],
        ...
        # -----------------------------------------------------
        if "leftHandLandmarks" not in result:
            for i in range(21):  #
                data.append({
                    'type': 'left_hand',
                    'landmark_index': i,
            ...
            # assert (len(result.leftHandLandmarks.landmark) == 21)
            for i in range(21):  #
                xyz = result["leftHandLandmarks"][i]
                data.append({
                    'type': 'left_hand',
                    'landmark_index': i,
                    'x': xyz['x'],
        ...
        if "poseLandmarks" not in result:
            for i in range(33):  #
                data.append({
                    'type': 'pose',
                    'landmark_index': i,
        ...
        # -----------------------------------------------------
        if "rightHandLandmarks" not in result:
            for i in range(21):  #
                data.append({
                    'type': 'right_hand',
                    'landmark_index': i,
            ...
            for i in range(21):  #
                xyz = result["rightHandLandmarks"][i]
                data.append({
                    'type': 'right_hand',
                    'landmark_index': i,
                    'x': xyz['x'],
